document.addEventListener('readystatechange',function(){
	if(document.readyState === 'complete'){
		...
		var musics = [
			{name:'我很快乐',src:'1.mp3',singer:'刘惜君',duration:'3:00'},
			{name:'G.E.M. 邓紫棋 - 后会无期 (《后会无期》电影同名主题歌)',src:'2.mp3',singer:'邓紫棋',duration:'3:43'},
			{name:'你是我的风景',src:'3.mp3',singer:'何洁',duration:'4:09'},
			{name:'愿得一人心 (《最美的时光》电视剧主题曲)',src:'4.mp3',singer:'李行亮',duration:'4:37'},
			{name:'戚黑白之间 (伴奏)',src:'5.mp3',singer:'戚薇',duration:'4:55'},
		    {name:'下辈子如果我还记得你',src:'6.mp3',singer:'马郁',duration:'3:48'},
			{name:'我不会在老地方等你',src:'7.mp3',singer:'庄心妍',duration:'4:16'},
			{name:'其实都没有',src:'8.mp3',singer:'杨宗纬',duration:'3:51'},
			{name:'时间都去哪儿了 (《老牛家的战争》电视剧主题曲_《空巢姥爷》电视剧主题曲_《私人订制》电影插曲).mp3',src:'9.mp3',singer:'戚薇',duration:'3:42'},
		    {name:'我知道你很难过 (Live)',src:'10.mp3',singer:'蔡依林',duration:'8:44'},
		    {name:'淘汰',src:'11.mp3',singer:'陈奕迅',duration:'4:45'},
			{name:'白天不懂夜的黑',src:'12.mp3',singer:'那英',duration:'4:02'},
			{name:'如果爱忘了',src:'13.mp3',singer:'戚薇',duration:'3:59'},
			{name:'怪我不配',src:'14.mp3',singer:'伍华',duration:'3:57'}
		];
		//uireset
